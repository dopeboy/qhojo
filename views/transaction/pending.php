...
<div class="sheet" id="pending">
    ...
    <p>Before your item can be formally reserved, <?php echo $transaction['BORROWER_FIRST_NAME'] ?> will need to submit his or her payments details to us. 
    ...
    <p>
        You will be notified by email once <?php echo $transaction['BORROWER_FIRST_NAME'] ?> has submitted his or her payment details. Click <a href="/user/dashboard/">here</a> to return to your dashboard.
    </p>
    <?php } ?>
</div>
