...
CREATE OR REPLACE VIEW RETURNED_AND_NEED_LENDER_FEEDBACK_BASE_VW AS
SELECT 
TRANSACTION_ID,
max(ENTRY_DATE) as "END_STATE_DATE",
MAX(STATE_B_ID)
...
CREATE OR REPLACE VIEW RETURNED_AND_NEED_LENDER_FEEDBACK_VW AS
SELECT 
s.*
FROM RETURNED_AND_NEED_LENDER_FEEDBACK_BASE_VW a 
inner join BASE_VW s on s.TRANSACTION_ID=a.TRANSACTION_ID
ORDER BY a.END_STATE_DATE ASC, s.TRANSACTION_ID, s.STATE_A_ID;

CREATE OR REPLACE VIEW RETURNED_AND_NEED_BORROWER_FEEDBACK_BASE_VW AS
SELECT 
TRANSACTION_ID,
max(ENTRY_DATE) as "END_STATE_DATE",
MAX(STATE_B_ID)
...
CREATE OR REPLACE VIEW RETURNED_AND_NEED_BORROWER_FEEDBACK_VW AS
SELECT 
s.*
FROM RETURNED_AND_NEED_BORROWER_FEEDBACK_BASE_VW a 
inner join BASE_VW s on s.TRANSACTION_ID=a.TRANSACTION_ID
ORDER BY a.END_STATE_DATE ASC, s.TRANSACTION_ID, s.STATE_A_ID;
