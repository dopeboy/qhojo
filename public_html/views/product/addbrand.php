...
<div class="sheet">
    ...
    <legend>
        <?php if ($this->state == 1) { ?> Edit <?php } else { ?> Add <?php } ?> Brand
    </legend>    
    
    <form class="form-submit" id="add-brand" autocomplete="off" action="/product/addbrand/<?php echo $this->id == null ? "null" : $this->id; ?>/<?php echo $target;?>" method="post">	
