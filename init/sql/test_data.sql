...
insert into USER (FIRST_NAME, LAST_NAME, EMAIL_ADDRESS,PASSWORD,PHONE_NUMBER,PROFILE_PICTURE_FILENAME) VALUES ('Ron', 'Burgundy', 'ron@burgundy.com','ron','+19495214954','ron.jpg');
insert into USER (FIRST_NAME, LAST_NAME, EMAIL_ADDRESS,PASSWORD,PHONE_NUMBER,PROFILE_PICTURE_FILENAME) VALUES ('Brian', 'Fantana', 'brian@fantana.com','brian','+19495214954','brian.jpg');
insert into USER (FIRST_NAME, LAST_NAME, EMAIL_ADDRESS,PASSWORD,PHONE_NUMBER,PROFILE_PICTURE_FILENAME) VALUES ('Brick', 'Tamland', 'brick@tamland.com','brick','+19495214954','brick.jpg');
insert into USER (FIRST_NAME, LAST_NAME, EMAIL_ADDRESS,PASSWORD,PHONE_NUMBER,PROFILE_PICTURE_FILENAME) VALUES ('Veronica', 'Corningstone', 'veronica@corningstone.com','veronica','+19495214954','veronica.jpg');
...
insert into ITEM (TITLE,DESCRIPTION,RATE,DEPOSIT,LOCATION_ID,STATE_ID,LENDER_ID, BORROWER_ID, BORROW_DURATION, START_DATE, END_DATE, LENDER_TO_BORROWER_STARS, BORROWER_TO_LENDER_STARS) 
VALUES ('Gray Suit', 'In good condition. Used a couple times for newcasts.', 10,100,3,3,1,2,2,'2012-10-31','2012-11-02',5,4);
