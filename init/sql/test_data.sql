...
insert into ITEM (TITLE,DESCRIPTION,RATE,DEPOSIT,LOCATION_ID,STATE_ID,LENDER_ID, BORROWER_ID, START_DATE, END_DATE) 
VALUES ('Microphone', 'In good condition. Used a couple times for newcasts.', 10,100,2,1,1,2,'2012-10-31','2012-11-02');
insert into ITEM (TITLE,DESCRIPTION,RATE,DEPOSIT,LOCATION_ID,STATE_ID,LENDER_ID, BORROWER_ID, START_DATE, END_DATE, LENDER_TO_BORROWER_STARS, BORROWER_TO_LENDER_STARS) 
VALUES ('Gray Suit', 'In good condition. Used a couple times for newcasts.', 10,100,3,3,1,2,'2012-10-31','2012-11-02',5,4);
